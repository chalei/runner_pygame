...
class Spielfigur(pygame.sprite.Sprite):
    def __init__(self, initial_position, size):
        ...
        self.image = pygame.image.load('etc/hikingmanflaten_' + str(self.go_state) + '.png').convert_alpha()
    ...
    def update(self):
        ...
        if self.anim_cooldown < 0:
            ...
            if self.anim_air:
                ...
                if player_goodie_anim > 0:
                    if self.go_state == 1:
                        self.image = hikingmanflaten_1
                    if self.go_state == 2:
                        self.image = hikingmanflaten_2
                    if self.go_state == 3:
                        self.image = hikingmanflaten_3
                    if self.go_state == 4:
                        self.image = hikingmanflaten_4
                else:
                    if self.go_state == 1:
                        self.image = hikingmanflaten_1
                    if self.go_state == 2:
...
spielfigur_jump = pygame.image.load('etc/hikingmanflaten_5.png').convert_alpha()
spielfigur_jump_goodie = pygame.image.load('etc/hikingmanflaten_5.png').convert_alpha()
hikingmanflaten_1 = pygame.image.load('etc/hikingmanflaten_1.png').convert_alpha()
hikingmanflaten_1_goodie = pygame.image.load('etc/hikingmanflaten_1.png').convert_alpha()
hikingmanflaten_2 = pygame.image.load('etc/hikingmanflaten_2.png').convert_alpha()
hikingmanflaten_2_goodie = pygame.image.load('etc/hikingmanflaten_2.png').convert_alpha()
hikingmanflaten_3 = pygame.image.load('etc/hikingmanflaten_3.png').convert_alpha()
hikingmanflaten_3_goodie = pygame.image.load('etc/hikingmanflaten_3.png').convert_alpha()
hikingmanflaten_4 = pygame.image.load('etc/hikingmanflaten_4.png').convert_alpha()
hikingmanflaten_4_goodie = pygame.image.load('etc/hikingmanflaten_4.png').convert_alpha()
